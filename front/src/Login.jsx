...
function Login() {
    ...
    return (
        <div className="relative">
            ...
            <div className="z-20 p-4 m-8 origin-bottom-right transform border-4 border-tertiary lg:mx-56 md:mx-8 lg:-mt-80 rounded-2xl bg-lime-400">
                <div className="p-4 space-y-10 md:space-y-0 md:grid md:grid-cols-2">
                    ...
                    <div className="md:flex md:flex-col md:justify-center lg:pr-16">
                        ...
                        <div className="grid justify-center grid-cols-1 gap-1 md:gap-4 mx-4 md:grid-cols-2">
                            ...
                            <button type="button" className="h-12 px-8 text-base font-semibold tracking-wider text-white border rounded-full shadow-sm font-fontVollkorn my-6 bg-lime-50 bg-gradient-to-r from-green-500 via-green-700 to-green-800 hover:shadow-lg">Sign In</button>

                            <button type="button" className="h-12 px-8 text-base font-semibold tracking-wider text-white border rounded-full shadow-sm font-fontVollkorn my-6 bg-lime-50 bg-gradient-to-r from-green-500 via-green-700 to-green-800 hover:shadow-lg">Sign Up</button>
                        </div>

                        <div className="w-full flex items-center justify-center text-lg mb-4 text-white">
                            <div className="inline-flex h-1 mx-4 bg-lime-400 rounded-full w-52"></div>
                            or
                            <div className="inline-flex h-1 mx-4 bg-lime-400 rounded-full w-52"></div>
                        </div>
